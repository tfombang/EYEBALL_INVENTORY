...
namespace EYEBALL_INVENTORY.eyebinventoryDataSet1TableAdapters {
    ...
    public partial class categoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `categories` WHERE ((`category` = @p1))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `categories` (`category`) VALUES (@p1)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `categories` SET `category` = @p1 WHERE ((`category` = @p2))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `category` FROM `categories`";
